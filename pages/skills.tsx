...
export default function Skills() {
  const dataList = [
    ...
    {
      link: "https://www.freecodecamp.org/news/css-preprocessors/",
      title: "SASS 🔥",
    },
    ...
    { link: "https://nestjs.com", title: "nest ⚡️" },
    {
      ...
      title: "styled-components | tailwind | mui | bootstrap",
    },
    ...
    {
      link: "https://www.youtube.com/watch?v=IbeD6YarPvg",
      title: "Bonus : Figma + Photoshop + Kit Adobe + ux/ui proeficience 🐁",
    },
  ];
  ...
  return (
    <>
      <C.ListsContentLink
        data={dataList}
        title="Skills"
        subtitle="frontend 🔥 | backend ⚡️ | db and tools 🐁 i've already worked"
      />
    </>
  );
}
